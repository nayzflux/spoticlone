...
function Center() {
    ...
    return (
        <div className='flex-grow text-white h-screen overflow-y-scroll scrollbar-hide'>
            ...
            <section className="flex items-end space-x-7 bg-gradient-to-b to-black from-red-500 h-80 p-8">
                <img className="h-44 w-44 shadow-2xl" src={playlist?.images?.[0]?.url} alt="playlist image"></img>
                <div>
                    <p className="font-bold text-xs">PAYLIST</p>
